...
### Read in SF tress data

```{r}
sf_trees <- read_csv(here("data", "sf_trees", "sf_trees.csv"))
```

### Basic wrangling remindeers

Refresh some skills for data wrangling & summary statistics using functions int he 'dplyr package.
...
- Have to give it crs since there is no spatial data - don't have to do for the next part since there is spatial data
...
Read in SF roads shapefile (shp):
